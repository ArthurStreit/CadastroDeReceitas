...
<html lang="en">
    ...
    <body class="hold-transition sidebar-mini">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('receitas.index') }}" class="nav-link" id="receitas"><i class="nav-icon fa-solid fa-bowl-food"></i><p>Receitas</p></a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('ingredientes.index') }}" class="nav-link" id="ingredientes"><i class="nav-icon fa-solid fa-wheat-awn"></i><p>Ingredientes</p></a>
                        </li>
                    </ul>
                </nav>
            </div>
        ...
        <footer class="main-footer">
            ...
            <strong>Copyright &copy; 2023 - <a>Sistema: Cadastro de receitas</a>.</strong> All rights reserved.
        </footer>
